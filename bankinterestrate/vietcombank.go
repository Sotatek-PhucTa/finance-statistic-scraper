...
func init() {
	vietcombankScraper = &BankInfo{
		...
		RateInfo: BankRateInfo{
			...
			BusinessInterestRate: "https://portal.vietcombank.com.vn/UserControls/TVPortal.TyGia/pListLaiSuat.aspx?CusstomType=1&BacrhID=1&InrateType=&isEn=False&numAfter=2",
		},
	}
